...
さらに、backend / frontend の GitHub Actions workflow が成功し、CI/CD の第一段階を完了している。

---

## 次にやるべきこと

次に進むべきなのは **8. 自動デプロイを入れる** のうち、**CodePipeline とデプロイ戦略を理解すること** です。
...
- **GitHub Actions と CodePipeline の役割の違いを理解すること**
- **CodePipeline の Source / Build / Deploy を理解すること**
...
このリポジトリでは、GitHub Actions による backend / frontend の自動デプロイが成功している。
